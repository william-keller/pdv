            ...
            <table width="100%" class="stable">
                ...
                <tr>
                    ...
                    <td style="text-align:right;"><h4>
                            <span>R$ <strong><?= $cashsales->paid ? $this->tec->formatMoney($cashsales->paid + ($this->session->userdata('cash_in_hand')) - ($expenses->total ? $expenses->total : 0.00)) : $this->tec->formatMoney($this->session->userdata('cash_in_hand') - ($expenses->total ? $expenses->total : 0.00)); ?></strong></span>
                        </h4></td>
                </tr>
            </table>
        </div>
