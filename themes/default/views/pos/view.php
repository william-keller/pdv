...
<div id="wrapper">
   ...
   <!--<span class="pull-left col-xs-12"><a class="btn btn-block btn-success" href="#" id="email"><?= lang("email"); ?></a></span>-->
    ...
    <div id="receipt-data">
        <div class="text-center">
            ...
            if ($payments) {
                ...
                foreach ($payments as $payment) {
                  ...
                  if($payment->cartaovalor>=1) {
                        echo '</tr>';
                        echo '<tr>';
                        echo '<td>Cartão</td>';
                        echo '<td>' . lang("amount") . ': R$ ' . $this->tec->formatMoney($payment->cartaovalor) . '</td>';
                        echo '<td> *Autorizado com senha*</td>';
                                  
                    }
                  if($payment->chequevalor>=1) {
                        echo '</tr>';
                        echo '<tr>';
                        echo '<td>Cheque</td>';
                        echo '<td>' . lang("amount") . ': R$ ' . $this->tec->formatMoney($payment->chequevalor) . '</td>';
                        echo '<td></td>';
                ...
                //$ex1 = new QRCodeGenerator('http://www.nfe.fazenda.gov.br/portal/consulta.aspx?tipoConsulta=completa&tipoConteudo=XbSeqxE8pl8=');
      ...
      <span style="font-size:11px;">Tudo Network Tecnologia - (84) 98713-0035 / 99220-2118</span>
        <div style="clear:both;"></div>
    </div>
<?php if ($modal) {
