                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <?= lang('cost', 'cost'); ?>
                                    <?= form_input('cost', set_value('cost'),  'class="form-control tip dinheiroinput" id="cost"  required="required"'); ?>
                                </div>

                                <div class="form-group">
                                    <?= lang('price', 'price'); ?>
                                    <?= form_input('price', set_value('price'), 'class="form-control tip dinheiroinput" id="price"  required="required"'); ?>
                                </div>
