...
<head>
    ...
    <style>   #backgroundImage{z-index: 1;}#backgroundImage:before { content: "";  position: absolute; z-index: -1;  top: 0;  bottom: 0;  left: 0;  right: 0;  background-image: url('<?= $assets; ?>images/login_bg.jpg');
   background-position:center center;   background-repeat:no-repeat;    background-size: 100%;    opacity: 0.9;    filter:alpha(opacity=90); height:100%;    width:100%;       }
.login-box{  z-index:-1;        opacity: 1;   filter:alpha(opacity=100);    }      </style>
</head>
