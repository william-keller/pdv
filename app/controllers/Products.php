...
class Products extends MY_Controller
{
    ...
    function print_barcodes() {
      ...
      // configura impressar de barcode
        ...
        foreach ($products as $pr) {
            ...
            $html .= '<td style="font-size:12px; width:160px;  border: 0px!important; margin-left:20px;padding: 0px!important;"><br><strong style="font-size:12px;">' . $this->Settings->site_name . '</strong><br><strong style="font-size:10px;">' . $pr->name . '</strong><br>' . $this->product_barcode($pr->code, $pr->barcode_symbology, 20) . '<br><span class="price"><b>' .$this->Settings->currency_prefix. ' ' . number_format($pr->price, 2, ",", ".") . '</b></span><br><span style="font-size:10px;">Prazo de Troca: 15 dias.<br>_____/_____/______</span><br><br><strong style="font-size:10px;">' . $pr->name . '</strong><br><span class="price"><b>' .$this->Settings->currency_prefix. ' ' . number_format($pr->price, 2, ",", ".") . '</b></span><br><div style="margin-top:7px"><strong style="font-size:10px;">' . $pr->name . '</strong><br><span class="price"><b>' .$this->Settings->currency_prefix. ' ' . number_format($pr->price, 2, ",", ".") . '</b></span></div></td>';
            $r++;
        }
        $html .= '</tr></tbody>
        </table>';
    ...
    function print_labels() {
        ...
        foreach ($products as $pr) {
            $html .= '<div class="labels"><strong>' . $pr->name . '</strong><br>' . $this->product_barcode($pr->code, $pr->barcode_symbology, 25) . '<br><span class="price">' .$this->Settings->currency_prefix. ' ' . number_format($pr->price, 2, ",", ".") . '</span></div>';
        }
      ...
      if($quantidade>0 && $quantidade<=3){$imprime = 3;}elseif($quantidade>=4 && $quantidade<=6){$imprime = 6;}elseif($quantidade>=7 && $quantidade<=9){$imprime = 9;}elseif($quantidade>=10 && $quantidade<=12){$imprime = 12;}elseif($quantidade>=13 && $quantidade<=15){$imprime = 15;}elseif($quantidade>=16 && $quantidade<=18){$imprime = 18;}elseif($quantidade>=19 && $quantidade<=21){$imprime = 21;}elseif($quantidade>=22 && $quantidade<=24){$imprime = 24;}elseif($quantidade>=25 && $quantidade<=27){$imprime = 27;}elseif($quantidade>=28 && $quantidade<=30){$imprime = 30;}
       ...
       if($product->quantity == 0) {
            ...
            if((($r-1) % 3) == 0){
             ...
             $html .= '<td style="font-size:12px; width:160px;  border: 0px!important; margin-left:20px;padding: 0px!important;"><br><strong style="font-size:12px;">' . $this->Settings->site_name . '</strong><br><strong style="font-size:10px;">' . $product->name . '</strong><br>' . $this->product_barcode($product->code, $product->barcode_symbology, 20) . '<br><span class="price"><b>' .$this->Settings->currency_prefix. ' </span><span> ' . number_format($product->price, 2, ",", ".") . '</b></span><br><span style="font-size:10px;">Prazo de Troca: 15 dias.<br>_____/_____/______</span><br><br><strong style="font-size:10px;">' . $product->name . '</strong><br><span class="price"><b>' .$this->Settings->currency_prefix. ' ' . number_format($product->price, 2, ",", ".") . '</b></span><br><div style="margin-top:7px"><strong style="font-size:10px;">' . $product->name . '</strong><br><span class="price"><b>' .$this->Settings->currency_prefix. ' ' . number_format($product->price, 2, ",", ".") . '</b></span></div></td>';
         }
    ...
    function single_label($product_id = NULL, $warehouse_id = NULL)
    {
        ...
        if($product->quantity > 0) {
            for ($r = 1; $r <= $product->quantity; $r++) {
                $html .= '<div class="labels"><strong>' . $product->name . '</strong><br>' . $this->product_barcode($product->code, $product->barcode_symbology, 25) . ' <br><span class="price">'.lang('price') .': ' .$this->Settings->currency_prefix. ' ' .  number_format($product->price, 2, ",", ".") . '</span></div>';
            }
        } else {
            for ($r = 1; $r <= 10; $r++) {
                $html .= '<div class="labels"><strong>' . $product->name . '</strong><br>' . $this->product_barcode($product->code, $product->barcode_symbology, 25) . ' <br><span class="price">'.lang('price') .': ' .$this->Settings->currency_prefix. ' ' .  number_format($product->price, 2, ",", ".") . '</span></div>';
    ...
    function add() {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
                ...
                'price' => str_replace(array(".", ","), array("", "."), $this->input->post('price')),
                'cost' =>  str_replace(array(".", ","), array("", "."), $this->input->post('cost')),
